                ...
                Child = autoSizeContainer = new Container
                {
                    ...
                    Children = new Drawable[]
                    {
                        ...
                        boxSizeReference = new Box
                        {
                            ...
                            Colour = SRGBColour.Red.Opacity(0.2f),
                        }
                    }
                };
            });
        ...
        private void loadTest(int testType)
        {
            ...
            switch (testType)
            {
                ...
                case 2:
                    ...
                    addCornerMarkers(box, 10, SRGBColour.YellowGreen);

                    for (int i = 0; i < 40; i++)
                    {
                        box.Add(box = new InfofulBoxAutoSize
                        {
                            Colour = new SRGBColour(253, 253, 253, 255),
                    ...
                    testContainer.Add(new FillFlowContainer
                    {
                        ...
                        Children = new Drawable[]
                        {
                            new Container
                            {
                                ...
                                Children = new Drawable[]
                                {
                                    new Box { Colour = SRGBColour.Gray, RelativeSizeAxes = Axes.Both },
                                    new Container
                                    {
                                        AutoSizeAxes = Axes.Both,
                                        Anchor = Anchor.Centre,
